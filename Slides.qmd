...
While there are many amazing new remote data access services and prototcols, they are by no means a panacea. We still have to cope with the realities of limited storage throughput, limited network bandwidth, and limited parallelism support of computer systems. By in large, web data access will fall into three broad categories. APIs, Object Stores, and File Servers. Increasingly, object stores are being used as file servers, but there is still useful a distinction to be drawn. 
